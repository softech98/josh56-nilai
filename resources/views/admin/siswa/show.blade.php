                    ...
                    <div id="tab1" class="tab-pane fade active in">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-4">
                                            <div class="img-file">
                                                @if($siswa->foto)
                                                    <img src="{!! url('/').'/uploads/image/'.$siswa->foto !!}" alt="profile foto" class="img-max">
                                ...
                                <button id="edit{{ $siswa->nis }}" class="btn btn-warning">
    <i class="fa fa-pencil-square"></i> edit
</button>
                                {{-- <a href="javascript:void(0)" id="edit{{ $siswa->nis }}" class='btn btn-warning'>Edit</a> --}}
                                {{-- <a href="{{ route('siswa.edit', $siswa->nis) }}" class='btn btn-warning'>Edit</a> --}}
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    $('#edit{{ $siswa->nis }}').click(function(){
        $('#myModal').modal('show');
        $('.modal-body').load('{!! route("admin.siswa.edit", $siswa->nis) !!}')
    });
</script>
    {{-- <script type="text/javascript">
